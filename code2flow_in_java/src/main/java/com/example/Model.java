...
public class Model {
    ...
    public static class Variable {
        ...
        public String to_string() {
            if (this.points_to != null && (this.points_to instanceof Group || this.points_to instanceof Node)) {
                String ptsToken;
                TokenHolder points_to = (TokenHolder)this.points_to;
        ...
        public Object matches_variable(Variable variable) {
            if (this.is_attr()) {
                if (this.owner_token.equals(variable.token)) {
                    if (variable.points_to instanceof Group) {
                        ...
                        if (variable.points_to instanceof String) {
                            if (OWNER_CONST.containsValue((String) variable.points_to)) {
                ...
                if (variable.points_to instanceof Group) {
                    ...
                    if (points_to.group_type == GROUP_TYPE.get("NAMESPACE")) {
            ...
            if (this.token.equals(variable.token)) {
                ...
                if (variable.points_to instanceof Group) {
                    Group grp = (Group) variable.points_to;
                    if (grp.group_type.equals(GROUP_TYPE.get("CLASS")) && grp.get_constructor() != null) {
    ...
    public static class Node implements TokenHolder {
        ...
        public boolean is_attr() {
            return (this.parent != null &&
                    ...
                    (((Group) this.parent).group_type.equals(GROUP_TYPE.get("CLASS")) ||
                     ((Group) this.parent).group_type.equals(GROUP_TYPE.get("NAMESPACE"))));
        }
        ...
        public String namespace_ownership() {
            ...
            while (parentObj != null && (parentObj instanceof Group) &&
                    ((Group) parentObj).group_type.equals(GROUP_TYPE.get("CLASS"))) {
    ...
    public static class Group implements TokenHolder {
        ...
        public Group(String token, String group_type, String display_type, List<String> import_tokens, Integer line_number, Group parent, Object inherits) {
            ...
            if (!GROUP_TYPE.containsValue(group_type)) {
        ...
        public String filename() {
            if (this.group_type.equals(GROUP_TYPE.get("FILE"))) {
                return this.token;
            }
        ...
        public Node get_constructor() {
            if (!this.group_type.equals(GROUP_TYPE.get("CLASS")))
